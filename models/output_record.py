...
class MutPred2Output:
    ...
    __altered_set__ = set(('N-terminal_signal', 'Signal_helix',
                                        'C-terminal_signal', 'Signal_cleavage',
    ...
    __mechanism_order__ = ["VSL2B_disorder","B_factor","Surface_accessibility","Helix",
                          "Strand","Loop","N-terminal_signal","Signal_helix","C-terminal_signal",
                          ...
                          "Acetylation","ADP-ribosylation","Amidation","C-linked_glycosylation","Carboxylation","Disulfide_linkage",
                          "Farnesylation","Geranylgeranylation","GPI_anchor_amidation","Hydroxylation","Methylation","Myristoylation",
                          "N-linked_glycosylation","N-terminal_acetylation","O-linked_glycosylation","Palmitoylation","Phosphorylation",
                          "Proteolytic_cleavage","Pyrrolidone_carboxylic_acid","Sulfation","SUMOylation","Ubiquitylation","Motifs","Stability_ddG"]
    ...
    def to_series(self,flatfile_info=True) -> pd.Series:
        if flatfile_info:
            data = {"RefSeq_nuc" : self.mutation.seq.mapping.refseq_nuc,
                     "RefSeq_prot" : self.mutation.seq.mapping.refseq_prot,
                     "Ensembl_gene" : self.mutation.seq.mapping.ensg_id,
                     "Ensembl_nuc" : self.mutation.seq.mapping.enst_id,
                    "Ensembl_prot" : self.mutation.seq.mapping.ensp_id,
                    "Substitution" : self.mutation.mutation,
                    "MutPred2_Score" : self.mutation.mutpred_score}
        else:
            data = {'seq_hash' : self.mutation.seq.seq_hash,
