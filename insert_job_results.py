...
def insert_job_results(jobs_dirs_base=None,job_path=None, db_config_file="sql_configs.yaml", db_config_name="Local"):
    """
    ...
    """
    if (jobs_dirs_base is not None and job_path is not None) or (jobs_dirs_base is None and job_path is None):
        raise ValueError("specify either jobs_dirs_base or job_path")
